...
class StatusScreenScreenOneScreen extends StatelessWidget {
        ...
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                leading: Container(
                    ...
                    margin: getMargin(left: 40, top: 20, bottom: 13),
                    child: Stack(alignment: Alignment.centerRight, children: [
                      ...
                      AppbarCircleimage1(
                          ...
                          margin:
                              getMargin(left: 7, top: 4, right: 2, bottom: 4))
                    ])),
                centerTitle: true,
                title: AppbarImage1(
                ...
                actions: [
                  AppbarImage1(
                      ...
                      margin:
                          getMargin(left: 33, top: 13, right: 33, bottom: 13),
                      onTap: () {
                        onTapPhotoone(context);
                      })
                ]),
            body: Container(
                width: size.width,
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: AssetImage(ImageConstant.imgGroup472),
                        fit: BoxFit.cover)),
                child: Container(
                    width: double.maxFinite,
                    padding: getPadding(left: 1, top: 6, right: 1, bottom: 6),
                    child: Column(
                          ...
                          Padding(
                              ...
                              child: Row(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                        padding: getPadding(
                                            left: 15, top: 10, bottom: 11),
                                        child: Text("Yusuf mubarak",
                                            overflow: TextOverflow.ellipsis,
                                            textAlign: TextAlign.left,
                                            style: AppStyle
                                                .txtRobotoMedium15WhiteA700)),
                                    Padding(
                                        padding: getPadding(
                                            left: 7, top: 13, bottom: 11),
                                        child: Text("10 m",
                                            overflow: TextOverflow.ellipsis,
                                            textAlign: TextAlign.left,
                                            style: AppStyle
                                    ...
                                    CustomImageView(
                                        ...
                                        margin: getMargin(top: 17, bottom: 20)),
                                    CustomImageView(
                                        svgPath:
            ...
            bottomNavigationBar: CustomTextFormField(
                ...
                margin: getMargin(left: 15, right: 5, bottom: 39),
                ...
                suffix: Container(
                    margin: getMargin(left: 30, top: 10, right: 17, bottom: 10),
  ...
  onTapPhotoone(BuildContext context) {
